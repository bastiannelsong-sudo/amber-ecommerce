        ...
        <nav className="flex items-center justify-between py-4 lg:py-5">
          ...
          <div className="flex items-center gap-1 sm:gap-3 lg:gap-5 flex-1 justify-end">
            ...
            <Link
              ...
              className="relative w-11 h-11 flex items-center justify-center text-obsidian-700 hover:text-amber-gold-500 transition-colors duration-300"
            >
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={1.5}>
                <path strokeLinecap="round" strokeLinejoin="round" d="M4.318 6.318a4.5 4.5 0 000 6.364L12 20.364l7.682-7.682a4.5 4.5 0 00-6.364-6.364L12 7.636l-1.318-1.318a4.5 4.5 0 00-6.364 0z" />
              </svg>
              {mounted && wishlistItemCount > 0 && (
                <span className="absolute top-0.5 right-0.5 bg-amber-gold-500 text-white text-[10px] w-4 h-4 rounded-full flex items-center justify-center font-medium">
                  {wishlistItemCount}
                </span>
              )}
            </Link>
            ...
            <button
              ...
              aria-label="Cuenta"
              className="hidden sm:flex relative w-11 h-11 items-center justify-center text-obsidian-700 hover:text-amber-gold-500 transition-colors duration-300 cursor-pointer"
            >
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={1.5}>
          ...
          <div className="lg:hidden border-t border-pearl-200/60 py-6 animate-fade-in">
            <div className="flex flex-col">
              ...
              <a
                ...
                className="sm:hidden py-3.5 text-sm uppercase tracking-widest text-obsidian-700 hover:text-amber-gold-500 transition-colors duration-300 font-medium"
              >
