...
export default function ColeccionesPage() {
  const collections = [
    ...
    },
    {
      id: 2,
      name: 'Celestial',
      description: 'Inspirada en la belleza del cosmos y las estrellas',
    ...
    },
    {
      id: 4,
      name: 'Vintage',
      description: 'Elegancia clasica con un toque contemporaneo',
    ...
    },
    {
      id: 5,
      name: 'Minimalista',
      description: 'Simplicidad refinada en su maxima expresion',
    ...
    },
    {
      id: 6,
      name: 'Opulencia',
      description: 'Lujo extraordinario para ocasiones especiales',
        ...
        <div className="absolute inset-0 z-20 flex items-center justify-center">
          <div className="text-center text-white space-y-6 px-4 animate-fade-in">
            ...
            <p className="text-base lg:text-lg tracking-wide font-light max-w-2xl mx-auto text-pearl-200">
              Explora mundos de elegancia y distincion
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center max-w-3xl mx-auto mb-20">
            ...
            <p className="text-base text-platinum-600 leading-relaxed">
              Cada coleccion cuenta una historia unica. Desde la elegancia atemporal hasta la
              audacia contemporanea, encuentra piezas que reflejen tu personalidad y celebren
              tus momentos mas especiales.
            </p>
          </div>
            ...
            <div className="absolute inset-0 z-20 flex items-center justify-center">
              <div className="text-center text-white space-y-6 px-4 max-w-3xl">
                ...
                <p className="text-base lg:text-lg font-light max-w-2xl mx-auto text-pearl-200">
                  Una celebracion de la renovacion y el florecimiento. Piezas unicas que capturan
                  la esencia de la primavera en cada detalle.
                </p>
                <a
                  href="/catalogo"
